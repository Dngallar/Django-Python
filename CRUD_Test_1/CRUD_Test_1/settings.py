...
WSGI_APPLICATION = 'CRUD_Test_1.wsgi.application'
...
try:
    ...
    print('When you want to use social login, please see CRUD_Test_1/github_settings-dist.py')
